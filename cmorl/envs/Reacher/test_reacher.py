...
if __name__ == "__main__":
    ...
    cmd_args = parse_args()
    runs = test_utils.run_tests(reacher.ReacherEnv(goal_distance=cmd_args.distance, bias=cmd_args.bias, render_mode="human" if cmd_args.render else None), cmd_args)
